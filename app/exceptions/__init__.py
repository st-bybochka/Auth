from app.exceptions.user_exceptions import (UserAlreadyRegisteredException, UserNotFoundException,
                                            UserIncorrectLoginOrPasswordException, UserBlockedException,
                                            UserIncorrectLenPasswordException, UserNotDigitException,
                                            UserNotCapitalLetterException, UserNotSmallLetterException)
